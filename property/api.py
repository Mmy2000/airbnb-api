...
def properties_list(request):
    ...
    total_properties = properties.count()  # initial count before filtering
    ...
    if checkin_date and checkout_date:
        ...
        all_matches = list(set([res.property_id for res in exact_matches | overlap_matches]))
    ...
    # Prepare favorites
    if user:
        favorites = [p.id for p in properties if user in p.favorited.all()]
    ...
    return JsonResponse({"data": serializer.data, "favorites": favorites, "meta": meta})
